    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 35%;" role="document">
        <div class="modal-content rounded">
            ...
            <div class="modal-body" id="header">
                <div class="d-flex align-items-stretch bg-white border-0 shadow-e-sm rounded" style="height: 70px">
                ...
                <form id="modalUserForm" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="mt-4" id="generalGroup">
                        <div class="form-group" style="margin-top: 2rem; display: flex; flex-wrap: wrap;">
                            ...
                            <div style="width: 47%;height: 67px;margin-left: 10%;">
                    ...
                    <div class="mt-4" id="securityGroup" style="display:none">
                        ...
                        <div class="form-group" style="margin-top: 2rem;">
                            ...
                            <div style="width: 50%; height: 67px;">
