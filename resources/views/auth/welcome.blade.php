                        ...
                        <div aria-labelledby="mj-column-per-100" class="x_mj-column-per-100 x_outlook-group-fix mt-3"
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                ...
                                <tr>
                                    <td align="left">
                                        <div>
                                            <h6 style="font-size: 16px; line-height: 16px;">Hola, {{ $username }}:</h6>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="font-size: 16px">
                                        <p>¡Tu cuenta ha sido validada exitosamente! Ten en cuenta que al ser un usuario nuevo, tienes acceso limitado a
                                            las funciones de la plataforma, contacta con un administrador si tus permisos no son actualizados en breve
                                            o si necesitas acceso a funcionalidades extra.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="word-break:break-word; font-size:0px; padding-bottom: 20px; padding-top: 15px"><p
                                            style="font-size:1px; margin:0px auto; border-top:1px solid #DCDDDE; width:100%"></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                        <div style="color:#747F8D; font-size:13px; line-height:13px; text-align:left">
<!--                                            TODO actualizar enviar email a soporte-->
                                            <p style="margin-top: -7px">¿No solicitaste un registro en nuestra plataforma? <a
